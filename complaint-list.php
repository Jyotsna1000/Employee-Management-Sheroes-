...
$count=1;
	...
	echo'<tr><td>'.$count.'</td><td>'.$value["typeOfComplaint"].'</td><td>'.$value["name"].'</td><td>'.date("d/M/Y",$new_date).'</td><td><a id="button" href="complaint-delete.php?id='.$value["id"].'">DELETE</a></td><td><a id="button" href="complaint-view.php?id='.$value["id"].'">SELECT</a></td></tr>';
	$count+=1;
}
